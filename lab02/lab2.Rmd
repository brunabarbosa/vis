...
enade_2017_ufcg_str$horas_estudo <- as.numeric(enade_2017_ufcg_str$horas_estudo)  

unique(enade_2017_ufcg_str$horas_estudo)
unique(enade_2017_ufcg_str$NOME_CURSO)

enade_2017_ufcg_str$horas_estudo <- sort(enade_2017_ufcg_str$horas_estudo)

enade_2017_ufcg_str <- enade_2017_ufcg_str %>% drop_na()

enade_2017_ufcg_str <- order(enade_2017_ufcg_str$horas_estudo)
...
enade_2017_ufcg_str <- enade_2017_ufcg_str %>%
  ...
  mutate(area_curso = ifelse(NOME_CURSO == "Engenharia Ambiental", "HUMANAS", area_curso)) %>% 
  mutate(area_curso = ifelse(NOME_CURSO == "Engenharia Florestal", "HUMANAS", area_curso))
